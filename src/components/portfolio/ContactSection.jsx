...
export default function ContactSection() {
  ...
  const inputCls =
    "bg-card border-border hover:bg-primary hover:border-primary hover:text-white hover:placeholder:text-white/60 focus:border-primary/70 focus:bg-primary/[0.025] focus:text-foreground focus:placeholder:text-muted-foreground h-12 transition-all duration-300 pl-4";
          ...
          <motion.form {...fadeUp(0.15)} className="space-y-5" onSubmit={handleSubmit}>
            ...
            <GlowField>
              <Textarea
                ...
                className="bg-card border-border hover:bg-primary hover:border-primary hover:text-white hover:placeholder:text-white/60 focus:border-primary/70 focus:bg-primary/[0.025] focus:text-foreground focus:placeholder:text-muted-foreground min-h-[140px] resize-none transition-all duration-300 pl-4"
                value={form.message}
