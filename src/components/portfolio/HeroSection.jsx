...
function useTypingLoop(text, typeSpeed = 55, deleteSpeed = 25, pauseMs = 10000) {
  ...
  const showCursor = phase === "typing" && displayed.length < text.length;
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-20 pt-20">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="flex-shrink-0">
