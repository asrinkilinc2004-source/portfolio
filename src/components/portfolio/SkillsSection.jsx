        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((cat, i) => (
            <motion.div key={cat.title} {...fadeUp(i * 0.08)}>
              <TiltCard className="p-6 rounded-xl bg-card border-2 border-primary/50 h-full group hover:bg-primary dark:hover:bg-zinc-800 transition-colors duration-300">
