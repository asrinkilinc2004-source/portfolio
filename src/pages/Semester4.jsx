...
const MILESTONE_DONE = [true, true, true, false, false, false];
      ...
      <section className="px-6 pb-32">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Over het project */}
            <motion.div {...fadeUp(0.1)} className="rounded-xl border border-border bg-card p-8 space-y-4">
            ...
            {/* Voortgang */}
            <motion.div {...fadeUp(0.15)} className="rounded-xl border border-border bg-card p-8 space-y-5">
          ...
          <div className="space-y-6">
            ...
            {/* Tech stack */}
            <motion.div {...fadeUp(0.1)} className="rounded-xl border border-border bg-card p-6 space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {TAGS.map((tag) => (
                  <span key={tag} className="px-3 py-1 text-xs font-mono rounded-md bg-primary/10 text-primary border border-primary/20">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            {/* Team */}
            <motion.div {...fadeUp(0.15)} className="rounded-xl border border-border bg-card p-6 space-y-4">
              <div className="flex items-center gap-2">
            ...
            {/* Semester info */}
            <motion.div {...fadeUp(0.2)} className="rounded-xl border border-border bg-card p-6 space-y-3">
              <div className="flex items-center gap-2">
