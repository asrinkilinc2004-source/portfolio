  ...
  nl: {
    ...
    semester4: {
      ...
      ai: {
        ...
        conclusion: "Het AI-systeem functioneert zoals ontworpen: het telt unieke bezoekers, slaat snapshots op met geblurred gezichten en houdt een log bij. De combinatie van DeepFace, OpenCV en MediaPipe biedt een robuuste pijplijn voor realtime detectie en herkenning. Threading zorgt voor een vlotte gebruikerservaring. De techniek versterkt de Dark Tech-boodschap: het systeem weet wie er is geweest.",
      },
    },
  ...
  en: {
    ...
    semester4: {
      ...
      ai: {
        ...
        conclusion: "The AI system functions as designed: it counts unique visitors, saves snapshots with blurred faces and maintains a log. The combination of DeepFace, OpenCV and MediaPipe provides a robust pipeline for real-time detection and recognition. Threading ensures a smooth user experience. The technology reinforces the Dark Tech message: the system knows who has been there.",
      },
    },
  ...
  ar: {
    ...
    semester4: {
      ...
      ai: {
        ...
        conclusion: "يعمل نظام الذكاء الاصطناعي كما صُمِّم: يعد الزوار الفريدين ويحفظ لقطات بوجوه مطموسة ويحتفظ بسجل. يوفر الجمع بين DeepFace وOpenCV وMediaPipe خط معالجة قوي للكشف والتعرف في الوقت الفعلي. تضمن المعالجة المتوازية تجربة مستخدم سلسة. التقنية تعزز رسالة Dark Tech: النظام يعرف من كان هناك.",
      },
    },
  ...
  es: {
    ...
    semester4: {
      ...
      ai: {
        ...
        conclusion: "El sistema de IA funciona como fue diseñado: cuenta visitantes únicos, guarda capturas con rostros difuminados y mantiene un registro. La combinación de DeepFace, OpenCV y MediaPipe proporciona un pipeline robusto para detección y reconocimiento en tiempo real. El threading garantiza una experiencia de usuario fluida. La tecnología refuerza el mensaje Dark Tech: el sistema sabe quién ha estado allí.",
      },
    },
  ...
  zh: {
    ...
    semester4: {
      ...
      ai: {
        ...
        conclusion: "AI系统按设计运行：统计独立访客、保存面部模糊的快照并维护日志。DeepFace、OpenCV和MediaPipe的组合为实时检测和识别提供了强大的处理管线。多线程确保流畅的用户体验。该技术强化了Dark Tech的信息：系统知道谁来过这里。",
      },
    },
    notClickable: "不可点击",
  },
